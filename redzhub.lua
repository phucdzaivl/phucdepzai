            ...
            pcall(function()
                ...
                if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 500 then
                    for _, v546 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if _G.Auto Raid Pirate and v546:FindFirstChild("HumanoidRootPart") and v546:FindFirstChild("Humanoid") and v546.Humanoid.Health > 0 and (v546.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000 then
                            repeat
                                wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                            ...
                            until v546.Humanoid.Health <= 0 or not v546.Parent or _G.Auto Raid Pirate == false
                            NeedAttacking = false
                            StartMagnet = false
                        end
                    end
...
v485:AddToggle({
    ...
    Default = false,
    local BoneEnemies = {
    ["Reborn Skeleton"] = {Level = 1975, Pos = Vector3.new(-9506, 172, 6017)},
    ["Living Zombie"] = {Level = 2000, Pos = Vector3.new(-10150, 150, 5900)},
    ["Demonic Soul"] = {Level = 2025, Pos = Vector3.new(-9500, 162, 5680)},
    ["Posessed Mummy"] = {Level = 2050, Pos = Vector3.new(-10500, 162, 5680)}
}
...
spawn(function()
    while _G.AutoFarmBone do
        wait()
        pcall(function()
            for Name, Data in pairs(BoneEnemies) do
                if game:GetService("Players").LocalPlayer.Data.Level.Value >= Data.Level then
                    local Monster = game:GetService("Workspace").Enemies:FindFirstChild(Name)
                    if Monster and Monster:FindFirstChild("Humanoid") and Monster.Humanoid.Health > 0 then
                        repeat
                            ...
                            game:GetService("VirtualUser"):CaptureController()
                            game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                        until not _G.AutoFarmBone or not Monster.Parent or Monster.Humanoid.Health <= 0
                    else
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = Data.Pos
                    end
                end
            end
        end)
...
v489:AddToggle({
    ...
    Description = "Tự động đánh Terror Shank",
    Default = false,
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/NTTLOL/UIredzLibrary/refs/heads/main/UI%20Redz.txt"))()
v496:AddToggle({
    Name = "Bring Mod",
